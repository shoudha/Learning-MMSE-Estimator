function errs = e_CircMMSE(nAntennas, snr, nBatches, trials, nCoherence, AS, nPaths)

nSamples = 16*nAntennas;

%mse.CircMMSE
est = CircMMSE(snr, nAntennas, nPaths, AS, nCoherence, 1, nSamples);
